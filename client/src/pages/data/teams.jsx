...
import { Button, Box, Typography, TableContainer, Paper, TableBody, TableHead, TableCell, Table, TableRow, IconButton } from '@material-ui/core'
				...
				{number && !data &&
					<Box mt={2}>
						<Typography variant='body1'>
							{error ? 'No data found for this team.' : 'Loading...'}
						</Typography>
					</Box>
				}
				{number && data &&
